...
const OwnerPage = React.lazy(() => import('pages/Owner/OwnerPage'));
const RegistrationPage = React.lazy(() => import('pages/Registration/RegistrationPage'));
const ViolationPage = React.lazy(() => import('pages/Violation/ViolationPage'));
          ...
          <Switch>
            ...
            <MainLayout breakpoint={this.props.breakpoint}>
              <React.Suspense fallback={<PageSpinner />}>
                ...
                <Route exact path="/violations" component={ViolationPage} />
...
export default componentQueries(query)(Routers);
